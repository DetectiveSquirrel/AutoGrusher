...
function Rusher() {
	...
	this.getPartyAct = function() {
		...
		do {
			if (party.name !== me.name) {
				while (!party.area) {
					say("!Waiting for everyone to join my party");
					delay(500);
				}
	...
	this.chatEvent = function(nick, msg) {
		if (nick !== me.name) {
			switch (msg) {
				...
				case "players 0":
					if (nick === master) {
						this.Grush.RushSettings.WaitPlayerCount = 0;
						say("Waiting for players to join set to 0.");
					} else {
						say("I'm only accepting commands from my master.");
					}
				...
				case "players 1":
					if (nick === master) {
						this.Grush.RushSettings.WaitPlayerCount = 1;
						say("Waiting for players to join set to 1.");
					} else {
						say("I'm only accepting commands from my master.");
					}
				...
				case "players 2":
					if (nick === master) {
						this.Grush.RushSettings.WaitPlayerCount = 2;
						say("Waiting for players to join set to 2.");
					} else {
						say("I'm only accepting commands from my master.");
					}
				...
				case "players 3":
					if (nick === master) {
						this.Grush.RushSettings.WaitPlayerCount = 3;
						say("Waiting for players to join set to 3.");
					} else {
						say("I'm only accepting commands from my master.");
					}
				...
				case "players 4":
					if (nick === master) {
						this.Grush.RushSettings.WaitPlayerCount = 4;
						say("Waiting for players to join set to 4.");
					} else {
						say("I'm only accepting commands from my master.");
					}
				...
				case "players 5":
					if (nick === master) {
						this.Grush.RushSettings.WaitPlayerCount = 5;
						say("Waiting for players to join set to 5.");
					} else {
						say("I'm only accepting commands from my master.");
					}
				...
				case "players 6":
					if (nick === master) {
						this.Grush.RushSettings.WaitPlayerCount = 6;
						say("Waiting for players to join set to 6.");
					} else {
						say("I'm only accepting commands from my master.");
					}
				...
				case "players 7":
					if (nick === master) {
						this.Grush.RushSettings.WaitPlayerCount = 7;
						say("Waiting for players to join set to 7.");
					} else {
						say("I'm only accepting commands from my master.");
					}
				...
				case "players 8":
					if (nick === master) {
						this.Grush.RushSettings.WaitPlayerCount = 8;
						say("Waiting for players to join set to 8.");
					} else {
						say("I'm only accepting commands from my master.");
					}
	...
	while (this.getPlayerCount() < Math.min(8, this.Grush.RushSettings.WaitPlayerCount)) {
		say("!" + this.Grush.JSP + "Waiting for " + (Math.min(8, this.Grush.RushSettings.WaitPlayerCount)-this.getPlayerCount()) + " more players to join");
		delay(500);
	}
